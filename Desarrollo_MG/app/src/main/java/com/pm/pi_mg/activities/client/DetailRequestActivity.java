...
public class DetailRequestActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyToolbar.show(this, "Lugar de entrega", true);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(mDestinationLatLng).title("Entrega").icon(BitmapDescriptorFactory.fromResource(R.drawable.icon_pin_blue)));
