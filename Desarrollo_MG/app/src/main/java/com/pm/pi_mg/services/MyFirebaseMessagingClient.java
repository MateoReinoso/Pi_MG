...
import com.pm.pi_mg.channel.NotificationHelper;
import com.pm.pi_mg.receivers.AcceptReceiver;
import com.pm.pi_mg.receivers.CancelReceiver;
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (title != null){
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
                if (title.contains("Solicitud de entrega")){
